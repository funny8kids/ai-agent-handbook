...
- 复跑读数：`inventory: hint=257 stepper=54 step=279 tabs=52 tab=195 | excluded quoted-in-markup mentions: hint=23 stepper=8 tabs=11 tab=7 step=6 | pages carrying a widget=189`，同一文件配平腿 `pages=198 problems=0`，exit 0。
