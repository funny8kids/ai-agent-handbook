...
- **要去面试：01–12 走完再进 [20 面试真题](../20-interview/README.md)**，先用 [岗位分档与转岗真题](../20-interview/career-tracks.md) 定住考哪几轮，再挑对应页，不要十四页全刷
...
| 顺序 | 20 导读 → [岗位分档与转岗真题](../20-interview/career-tracks.md) 定档 → 按岗位挑 2–3 页（数据/评测/安全/多模态/前沿各一页）→ 手撕与行为面各留一晚模拟 → 回原章节补漏 |
