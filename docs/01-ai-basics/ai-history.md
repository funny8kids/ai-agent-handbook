...
- 开源力量（DeepSeek、Qwen、Pi 等）把 Agent 技术拉平到所有人可用
...
| 2026.04 | Pi 破 4 万 Star（后于 2026 年更名为 earendil-works/pi） | 极简 harness 路线得到社区认可 |
...
- ❌ 开源只是跟随大厂：DeepSeek 的 MoE/推理训练、Pi 的 harness 设计都有原创性贡献
