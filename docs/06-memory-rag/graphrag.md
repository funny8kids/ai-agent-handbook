...
- **GraphRAG 与 Agent 结合**：DeepSeek Harness 的 `context` 包把「上下文提供者」做成插件（[仓库](https://github.com/deepseek-ai/deepseek-harness)）——GraphRAG 可以作为一个 context provider 挂进 preStep 的动态上下文组装，而非独立的问答系统
