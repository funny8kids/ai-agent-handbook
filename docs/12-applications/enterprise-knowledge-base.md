...
- **DeepSeek Harness 的 context 插件**（[仓库](https://github.com/deepseek-ai/deepseek-harness)）：企业知识检索作为 context provider 挂入 Agent 上下文组装——知识库不只服务问答，还能成为所有内部 Agent 的「事实源」
